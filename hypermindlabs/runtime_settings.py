...
DEFAULT_RUNTIME_SETTINGS: dict[str, Any] = {
    ...
    "telegram": {
        ...
        "public_group_disclaimer_enabled": False,
    ...
    "documents": {
        ...
        "storage_local_path": "db/document_objects",
        "upload_max_bytes": 104857600,
        "upload_chunk_bytes": 1048576,
        "allow_empty_uploads": False,
        "retention_default_days": 365,
        "delete_grace_days": 30,
        "ingestion_pipeline_version": "v1",
        "ingestion_default_priority": 100,
        ...
        "ingestion_worker_lease_seconds": 45,
        "ingestion_worker_heartbeat_seconds": 10.0,
        "pdf_max_pages": 500,
        "pdf_text_timeout_seconds": 30.0,
        "pdf_layout_enabled": True,
        "pdf_table_extraction_enabled": True,
        "pdf_table_max_per_page": 6,
        "pdf_table_min_cells": 4,
        "pdf_ocr_enabled": True,
        "pdf_ocr_force": False,
        "pdf_ocr_max_pages": 120,
        "pdf_ocr_timeout_seconds": 90.0,
        "pdf_ocr_min_text_density": 0.015,
        "pdf_ocr_min_scanned_page_ratio": 0.35,
        "html_drop_tags": [
            "script",
            "style",
            "noscript",
        ...
        "office_xlsx_max_rows": 300,
        "office_xlsx_max_cols": 20,
        "office_pptx_max_slides": 200,
        "structured_max_depth": 8,
        "structured_max_items": 4000,
        "structured_value_max_chars": 400,
        "structured_csv_max_rows": 2000,
        "structured_csv_max_cols": 32,
        "structured_csv_low_signal_headers": ["id", "idx", "index", "row", "row_id", "number", "no"],
        "chunk_target_tokens": 220,
        "chunk_overlap_tokens": 40,
        "chunk_max_tokens": 320,
        "chunk_max_chunks_per_node": 16,
        "chunk_max_total_chunks": 6000,
        "chunk_list_items_per_chunk": 12,
        "chunk_table_rows_per_chunk": 20,
        "chunk_code_lines_per_chunk": 20,
        "taxonomy_enabled": True,
        "taxonomy_topic_limit": 8,
        "taxonomy_topic_min_confidence": 0.2,
        "taxonomy_domain_min_confidence": 0.2,
        "taxonomy_format_min_confidence": 0.2,
        "taxonomy_synonym_expansion": True,
        "taxonomy_max_labels_per_record": 6,
        "parser_router_enabled": True,
        "parser_fallback_enabled": True,
        "parser_min_confidence": 0.35,
        "parser_max_fallback_adapters": 3,
        "parser_probe_bytes": 8192,
        "parser_cost_ceiling": 10.0,
        "parser_preferred_adapters": [
            "pdf-text-layout",
            "pdf-ocr",
            "office-suite",
            "html-web",
        ...
        "parser_enabled_adapters": [],
        "parser_format_allowlist": [],
        "parser_format_denylist": [],
    },
    "conversation": {
...
ENV_OVERRIDES: dict[str, tuple[tuple[str, ...], str]] = {
    ...
    "documents.storage_local_path": (("RYO_DOCUMENT_STORAGE_LOCAL_PATH",), "str"),
    "documents.upload_max_bytes": (("RYO_DOCUMENT_UPLOAD_MAX_BYTES",), "int"),
    "documents.upload_chunk_bytes": (("RYO_DOCUMENT_UPLOAD_CHUNK_BYTES",), "int"),
    "documents.retention_default_days": (("RYO_DOCUMENT_RETENTION_DEFAULT_DAYS",), "int"),
    "documents.ingestion_pipeline_version": (("RYO_DOCUMENT_INGESTION_PIPELINE_VERSION",), "str"),
    "documents.ingestion_default_priority": (("RYO_DOCUMENT_INGESTION_DEFAULT_PRIORITY",), "int"),
    "documents.ingestion_job_max_attempts": (("RYO_DOCUMENT_INGESTION_JOB_MAX_ATTEMPTS",), "int"),
    "documents.ingestion_retry_base_seconds": (("RYO_DOCUMENT_INGESTION_RETRY_BASE_SECONDS",), "int"),
    "documents.ingestion_retry_max_seconds": (("RYO_DOCUMENT_INGESTION_RETRY_MAX_SECONDS",), "int"),
    "documents.ingestion_worker_enabled": (("RYO_DOCUMENT_INGESTION_WORKER_ENABLED",), "bool"),
    "documents.ingestion_worker_poll_seconds": (("RYO_DOCUMENT_INGESTION_WORKER_POLL_SECONDS",), "float"),
    "documents.ingestion_worker_lease_seconds": (("RYO_DOCUMENT_INGESTION_WORKER_LEASE_SECONDS",), "int"),
    "documents.ingestion_worker_heartbeat_seconds": (("RYO_DOCUMENT_INGESTION_WORKER_HEARTBEAT_SECONDS",), "float"),
    "documents.pdf_max_pages": (("RYO_DOCUMENT_PDF_MAX_PAGES",), "int"),
    "documents.pdf_text_timeout_seconds": (("RYO_DOCUMENT_PDF_TEXT_TIMEOUT_SECONDS",), "float"),
    "documents.pdf_layout_enabled": (("RYO_DOCUMENT_PDF_LAYOUT_ENABLED",), "bool"),
    "documents.pdf_table_extraction_enabled": (("RYO_DOCUMENT_PDF_TABLE_EXTRACTION_ENABLED",), "bool"),
    "documents.pdf_table_max_per_page": (("RYO_DOCUMENT_PDF_TABLE_MAX_PER_PAGE",), "int"),
    "documents.pdf_table_min_cells": (("RYO_DOCUMENT_PDF_TABLE_MIN_CELLS",), "int"),
    "documents.pdf_ocr_enabled": (("RYO_DOCUMENT_PDF_OCR_ENABLED",), "bool"),
    "documents.pdf_ocr_force": (("RYO_DOCUMENT_PDF_OCR_FORCE",), "bool"),
    "documents.pdf_ocr_max_pages": (("RYO_DOCUMENT_PDF_OCR_MAX_PAGES",), "int"),
    "documents.pdf_ocr_timeout_seconds": (("RYO_DOCUMENT_PDF_OCR_TIMEOUT_SECONDS",), "float"),
    "documents.pdf_ocr_min_text_density": (("RYO_DOCUMENT_PDF_OCR_MIN_TEXT_DENSITY",), "float"),
    "documents.pdf_ocr_min_scanned_page_ratio": (("RYO_DOCUMENT_PDF_OCR_MIN_SCANNED_PAGE_RATIO",), "float"),
    "documents.html_drop_tags": (("RYO_DOCUMENT_HTML_DROP_TAGS",), "csv"),
    "documents.office_xlsx_max_rows": (("RYO_DOCUMENT_OFFICE_XLSX_MAX_ROWS",), "int"),
    "documents.office_xlsx_max_cols": (("RYO_DOCUMENT_OFFICE_XLSX_MAX_COLS",), "int"),
    "documents.office_pptx_max_slides": (("RYO_DOCUMENT_OFFICE_PPTX_MAX_SLIDES",), "int"),
    "documents.structured_max_depth": (("RYO_DOCUMENT_STRUCTURED_MAX_DEPTH",), "int"),
    "documents.structured_max_items": (("RYO_DOCUMENT_STRUCTURED_MAX_ITEMS",), "int"),
    "documents.structured_value_max_chars": (("RYO_DOCUMENT_STRUCTURED_VALUE_MAX_CHARS",), "int"),
    "documents.structured_csv_max_rows": (("RYO_DOCUMENT_STRUCTURED_CSV_MAX_ROWS",), "int"),
    "documents.structured_csv_max_cols": (("RYO_DOCUMENT_STRUCTURED_CSV_MAX_COLS",), "int"),
    "documents.structured_csv_low_signal_headers": (("RYO_DOCUMENT_STRUCTURED_CSV_LOW_SIGNAL_HEADERS",), "csv"),
    "documents.chunk_target_tokens": (("RYO_DOCUMENT_CHUNK_TARGET_TOKENS",), "int"),
    "documents.chunk_overlap_tokens": (("RYO_DOCUMENT_CHUNK_OVERLAP_TOKENS",), "int"),
    "documents.chunk_max_tokens": (("RYO_DOCUMENT_CHUNK_MAX_TOKENS",), "int"),
    "documents.chunk_max_chunks_per_node": (("RYO_DOCUMENT_CHUNK_MAX_CHUNKS_PER_NODE",), "int"),
    "documents.chunk_max_total_chunks": (("RYO_DOCUMENT_CHUNK_MAX_TOTAL_CHUNKS",), "int"),
    "documents.chunk_list_items_per_chunk": (("RYO_DOCUMENT_CHUNK_LIST_ITEMS_PER_CHUNK",), "int"),
    "documents.chunk_table_rows_per_chunk": (("RYO_DOCUMENT_CHUNK_TABLE_ROWS_PER_CHUNK",), "int"),
    "documents.chunk_code_lines_per_chunk": (("RYO_DOCUMENT_CHUNK_CODE_LINES_PER_CHUNK",), "int"),
    "documents.taxonomy_enabled": (("RYO_DOCUMENT_TAXONOMY_ENABLED",), "bool"),
    "documents.taxonomy_topic_limit": (("RYO_DOCUMENT_TAXONOMY_TOPIC_LIMIT",), "int"),
    "documents.taxonomy_topic_min_confidence": (("RYO_DOCUMENT_TAXONOMY_TOPIC_MIN_CONFIDENCE",), "float"),
    "documents.taxonomy_domain_min_confidence": (("RYO_DOCUMENT_TAXONOMY_DOMAIN_MIN_CONFIDENCE",), "float"),
    "documents.taxonomy_format_min_confidence": (("RYO_DOCUMENT_TAXONOMY_FORMAT_MIN_CONFIDENCE",), "float"),
    "documents.taxonomy_synonym_expansion": (("RYO_DOCUMENT_TAXONOMY_SYNONYM_EXPANSION",), "bool"),
    "documents.taxonomy_max_labels_per_record": (("RYO_DOCUMENT_TAXONOMY_MAX_LABELS_PER_RECORD",), "int"),
    "documents.parser_router_enabled": (("RYO_DOCUMENT_PARSER_ROUTER_ENABLED",), "bool"),
    "documents.parser_fallback_enabled": (("RYO_DOCUMENT_PARSER_FALLBACK_ENABLED",), "bool"),
    "documents.parser_min_confidence": (("RYO_DOCUMENT_PARSER_MIN_CONFIDENCE",), "float"),
    "documents.parser_max_fallback_adapters": (("RYO_DOCUMENT_PARSER_MAX_FALLBACK_ADAPTERS",), "int"),
    "documents.parser_probe_bytes": (("RYO_DOCUMENT_PARSER_PROBE_BYTES",), "int"),
    "documents.parser_cost_ceiling": (("RYO_DOCUMENT_PARSER_COST_CEILING",), "float"),
    "documents.parser_preferred_adapters": (("RYO_DOCUMENT_PARSER_PREFERRED_ADAPTERS",), "csv"),
    "documents.parser_enabled_adapters": (("RYO_DOCUMENT_PARSER_ENABLED_ADAPTERS",), "csv"),
    "documents.parser_format_allowlist": (("RYO_DOCUMENT_PARSER_FORMAT_ALLOWLIST",), "csv"),
    "documents.parser_format_denylist": (("RYO_DOCUMENT_PARSER_FORMAT_DENYLIST",), "csv"),
    ...
    "telegram.public_group_disclaimer_enabled": (("RYO_TELEGRAM_PUBLIC_GROUP_DISCLAIMER_ENABLED",), "bool"),
