        ...
        categories=(
            RouteCategorySpec(
                ...
                settings=(
                    ...
                    RouteSettingSpec(
                        id="stage_update_min_interval_seconds",
                        label="Stage Update Min Interval (s)",
                        path="runtime.telegram.stage_update_min_interval_seconds",
                        value_type="float",
                        description="Minimum delay between Telegram status message edits to avoid hot-path blocking.",
                        default_runtime_path="telegram.stage_update_min_interval_seconds",
                        min_value=0.1,
                        max_value=15.0,
                        env_override_keys=("RYO_TELEGRAM_STAGE_UPDATE_MIN_INTERVAL_SECONDS",),
                    ),
                    RouteSettingSpec(
                    ...
                    RouteSettingSpec(
                        id="group_context_isolation_enabled",
                        label="Group Context Isolation",
                        path="runtime.telegram.group_context_isolation_enabled",
                        value_type="bool",
                        description="Enforce per-group context partitioning metadata and retrieval scope boundaries.",
                        default_runtime_path="telegram.group_context_isolation_enabled",
                        env_override_keys=("RYO_TELEGRAM_GROUP_CONTEXT_ISOLATION_ENABLED",),
                    ),
                    RouteSettingSpec(
                        id="group_storage_mode",
                        label="Group Storage Mode",
                        path="runtime.telegram.group_storage_mode",
                        value_type="string",
                        description="Group storage isolation mode: shared_pg or dedicated_pg metadata layout.",
                        default_runtime_path="telegram.group_storage_mode",
                        choices=("shared_pg", "dedicated_pg"),
                        env_override_keys=("RYO_TELEGRAM_GROUP_STORAGE_MODE",),
                    ),
                    RouteSettingSpec(
                        id="group_storage_prefix",
                        label="Group Storage Prefix",
                        path="runtime.telegram.group_storage_prefix",
                        value_type="string",
                        description="Prefix used when generating per-group storage keys.",
            ...
            RouteCategorySpec(
                ...
                settings=(
                    ...
                    RouteSettingSpec(
                        id="analysis_bypass_small_talk_enabled",
                        label="Analysis Bypass On Small Talk",
                        path="runtime.orchestrator.analysis_bypass_small_talk_enabled",
                        value_type="bool",
                        description="Skip heavyweight analysis for short social turns when no explicit recall is requested.",
                        default_runtime_path="orchestrator.analysis_bypass_small_talk_enabled",
                        env_override_keys=("RYO_ORCHESTRATOR_ANALYSIS_BYPASS_SMALL_TALK_ENABLED",),
                    ),
                    RouteSettingSpec(
                        id="analysis_history_limit",
                        label="Analysis History Limit",
                        path="runtime.orchestrator.analysis_history_limit",
                        value_type="int",
                        description="Recent dialogue messages passed into the analysis stage.",
                        default_runtime_path="orchestrator.analysis_history_limit",
                        min_value=1,
                        max_value=50,
                        env_override_keys=("RYO_ORCHESTRATOR_ANALYSIS_HISTORY_LIMIT",),
                    ),
                    RouteSettingSpec(
                        id="analysis_history_limit_on_switch",
                        label="Analysis History Limit On Switch",
                        path="runtime.orchestrator.analysis_history_limit_on_switch",
                        value_type="int",
                        description="Reduced analysis history window when topic-shift is detected.",
                        default_runtime_path="orchestrator.analysis_history_limit_on_switch",
                        min_value=1,
                        max_value=50,
                        env_override_keys=("RYO_ORCHESTRATOR_ANALYSIS_HISTORY_LIMIT_ON_SWITCH",),
                    ),
                    RouteSettingSpec(
                        id="analysis_history_limit_small_talk",
                        label="Analysis History Limit Small Talk",
                        path="runtime.orchestrator.analysis_history_limit_small_talk",
                        value_type="int",
                        description="History window cap for small-talk analysis turns.",
                        default_runtime_path="orchestrator.analysis_history_limit_small_talk",
                        min_value=1,
                        max_value=20,
                        env_override_keys=("RYO_ORCHESTRATOR_ANALYSIS_HISTORY_LIMIT_SMALL_TALK",),
                    ),
                    RouteSettingSpec(
                        id="tool_history_limit",
                        label="Tool Stage History Limit",
                        path="runtime.orchestrator.tool_history_limit",
                        value_type="int",
                        description="Recent dialogue messages provided to the tool planning stage.",
                        default_runtime_path="orchestrator.tool_history_limit",
                        min_value=1,
                        max_value=50,
                        env_override_keys=("RYO_ORCHESTRATOR_TOOL_HISTORY_LIMIT",),
                    ),
                    RouteSettingSpec(
                        id="response_history_limit",
                        label="Response History Limit",
                        path="runtime.orchestrator.response_history_limit",
                        value_type="int",
                        description="Recent dialogue messages used for final response synthesis.",
                        default_runtime_path="orchestrator.response_history_limit",
                        min_value=1,
                        max_value=100,
                        env_override_keys=("RYO_ORCHESTRATOR_RESPONSE_HISTORY_LIMIT",),
                    ),
                    RouteSettingSpec(
                        id="auto_expand_tool_stage_enabled",
                        label="Auto Expand Tool Stage",
                        path="runtime.orchestrator.auto_expand_tool_stage_enabled",
                        value_type="bool",
                        description="Escalate to tool planning when analysis hints imply tools are likely needed.",
                        default_runtime_path="orchestrator.auto_expand_tool_stage_enabled",
                        env_override_keys=("RYO_ORCHESTRATOR_AUTO_EXPAND_TOOL_STAGE_ENABLED",),
                    ),
                    RouteSettingSpec(
                        id="auto_expand_max_rounds",
                        label="Auto Expand Max Rounds",
                        path="runtime.orchestrator.auto_expand_max_rounds",
                        value_type="int",
                        description="Maximum additional tool-planning retries when expansion mode is active.",
                        default_runtime_path="orchestrator.auto_expand_max_rounds",
                        min_value=0,
                        max_value=5,
                        env_override_keys=("RYO_ORCHESTRATOR_AUTO_EXPAND_MAX_ROUNDS",),
                    ),
                    RouteSettingSpec(
                        id="progress_stage_events_enabled",
                        label="Progress Stage Events",
                        path="runtime.orchestrator.progress_stage_events_enabled",
                        value_type="bool",
                        description="Emit granular analysis/response progress events (verbose; may increase stage churn).",
                        default_runtime_path="orchestrator.progress_stage_events_enabled",
                        env_override_keys=("RYO_ORCHESTRATOR_PROGRESS_STAGE_EVENTS_ENABLED",),
                    ),
                    RouteSettingSpec(
                    ...
                    RouteSettingSpec(
                        id="control_plane_cache_enabled",
                        label="Control Plane Cache Enabled",
                        path="runtime.orchestrator.control_plane_cache_enabled",
                        value_type="bool",
                        description="Cache policies/system-prompts for a short TTL to avoid per-turn control-plane churn.",
                        default_runtime_path="orchestrator.control_plane_cache_enabled",
                        env_override_keys=("RYO_ORCHESTRATOR_CONTROL_PLANE_CACHE_ENABLED",),
                    ),
                    RouteSettingSpec(
                        id="control_plane_cache_ttl_seconds",
                        label="Control Plane Cache TTL (s)",
                        path="runtime.orchestrator.control_plane_cache_ttl_seconds",
                        value_type="float",
                        description="Seconds to reuse cached policy/system prompt artifacts before refresh.",
                        default_runtime_path="orchestrator.control_plane_cache_ttl_seconds",
                        min_value=0.0,
                        max_value=3600.0,
                        env_override_keys=("RYO_ORCHESTRATOR_CONTROL_PLANE_CACHE_TTL_SECONDS",),
                    ),
                    RouteSettingSpec(
            ...
            RouteCategorySpec(
                ...
                settings=(
                    ...
                    RouteSettingSpec(
                        id="stream_first_token_timeout_seconds",
                        label="Stream First Token Timeout (s)",
                        path="runtime.inference.stream_first_token_timeout_seconds",
                        value_type="float",
                        description="Max seconds to wait for the first streamed token before fallback/degrade handling.",
                        default_runtime_path="inference.stream_first_token_timeout_seconds",
                        min_value=1.0,
                        max_value=600.0,
                        env_override_keys=("RYO_OLLAMA_STREAM_FIRST_TOKEN_TIMEOUT_SECONDS",),
                    ),
                    RouteSettingSpec(
                        id="stream_chunk_timeout_seconds",
                        label="Stream Chunk Timeout (s)",
                        path="runtime.inference.stream_chunk_timeout_seconds",
                        value_type="float",
                        description="Max idle seconds between streamed chunks before finalizing with available content.",
                        default_runtime_path="inference.stream_chunk_timeout_seconds",
                        min_value=1.0,
                        max_value=600.0,
                        env_override_keys=("RYO_OLLAMA_STREAM_CHUNK_TIMEOUT_SECONDS",),
                    ),
                    RouteSettingSpec(
                        id="stream_total_timeout_seconds",
                        label="Stream Total Timeout (s)",
                        path="runtime.inference.stream_total_timeout_seconds",
                        value_type="float",
                        description="Overall timeout for streamed analysis/response stages; set 0 to disable.",
                        default_runtime_path="inference.stream_total_timeout_seconds",
                        min_value=0.0,
                        max_value=3600.0,
                        env_override_keys=("RYO_OLLAMA_STREAM_TOTAL_TIMEOUT_SECONDS",),
                    ),
                    RouteSettingSpec(
                    ...
                    RouteSettingSpec(
                        id="defer_embeddings_on_write",
                        label="Defer Embeddings On Write",
                        path="runtime.inference.defer_embeddings_on_write",
                        value_type="bool",
                        description="Write chat history first and persist embeddings in background worker queue.",
                        default_runtime_path="inference.defer_embeddings_on_write",
                        env_override_keys=("RYO_DEFER_EMBEDDINGS_ON_WRITE",),
                    ),
                    RouteSettingSpec(
                        id="embedding_write_queue_size",
                        label="Embedding Write Queue Size",
                        path="runtime.inference.embedding_write_queue_size",
                        value_type="int",
                        description="Max queued chat-history embedding jobs for deferred background persistence.",
                        default_runtime_path="inference.embedding_write_queue_size",
                        min_value=16,
                        max_value=20000,
                        env_override_keys=("RYO_EMBEDDING_WRITE_QUEUE_SIZE",),
                    ),
                ),
            ),
            RouteCategorySpec(
            ...
            RouteCategorySpec(
                id="personality",
                label="Personality / Narrative",
                settings=(
                    RouteSettingSpec(
                        id="personality_enabled",
                        label="Personality Engine Enabled",
                        path="runtime.personality.enabled",
                        value_type="bool",
                        description="Enable per-user personality profile loading and style injection.",
                        default_runtime_path="personality.enabled",
                        env_override_keys=("RYO_PERSONALITY_ENABLED",),
                    ),
                    RouteSettingSpec(
                        id="personality_adaptive_enabled",
                        label="Adaptive Personality Enabled",
                        path="runtime.personality.adaptive_enabled",
                        value_type="bool",
                        description="Allow style adaptation based on observed user turn behavior signals.",
                        default_runtime_path="personality.adaptive_enabled",
                        env_override_keys=("RYO_PERSONALITY_ADAPTIVE_ENABLED",),
                    ),
                    RouteSettingSpec(
                        id="personality_narrative_enabled",
                        label="Narrative Rollup Enabled",
                        path="runtime.personality.narrative_enabled",
                        value_type="bool",
                        description="Persist and inject compact narrative continuity summaries.",
                        default_runtime_path="personality.narrative_enabled",
                        env_override_keys=("RYO_PERSONALITY_NARRATIVE_ENABLED",),
                    ),
                    RouteSettingSpec(
                        id="personality_max_injection_chars",
                        label="Max Injection Chars",
                        path="runtime.personality.max_injection_chars",
                        value_type="int",
                        description="Hard character budget for injected personality context payload.",
                        default_runtime_path="personality.max_injection_chars",
                        min_value=200,
                        max_value=4000,
                        env_override_keys=("RYO_PERSONALITY_MAX_INJECTION_CHARS",),
                    ),
                    RouteSettingSpec(
                        id="personality_narrative_summary_max_chars",
                        label="Narrative Summary Max Chars",
                        path="runtime.personality.narrative_summary_max_chars",
                        value_type="int",
                        description="Max narrative summary size persisted and injected in context.",
                        default_runtime_path="personality.narrative_summary_max_chars",
                        min_value=80,
                        max_value=3000,
                        env_override_keys=("RYO_PERSONALITY_NARRATIVE_SUMMARY_MAX_CHARS",),
                    ),
                    RouteSettingSpec(
                        id="personality_rollup_turn_threshold",
                        label="Rollup Turn Threshold",
                        path="runtime.personality.rollup_turn_threshold",
                        value_type="int",
                        description="Roll up narrative chunk when this many turns have accumulated since last rollup.",
                        default_runtime_path="personality.rollup_turn_threshold",
                        min_value=1,
                        max_value=100,
                        env_override_keys=("RYO_PERSONALITY_ROLLUP_TURN_THRESHOLD",),
                    ),
                    RouteSettingSpec(
                        id="personality_rollup_char_threshold",
                        label="Rollup Char Threshold",
                        path="runtime.personality.rollup_char_threshold",
                        value_type="int",
                        description="Roll up narrative chunk when accumulated chars cross this threshold.",
                        default_runtime_path="personality.rollup_char_threshold",
                        min_value=200,
                        max_value=50000,
                        env_override_keys=("RYO_PERSONALITY_ROLLUP_CHAR_THRESHOLD",),
                    ),
                    RouteSettingSpec(
                        id="personality_adaptation_min_turns",
                        label="Adaptation Min Turns",
                        path="runtime.personality.adaptation_min_turns",
                        value_type="int",
                        description="Minimum observed turns before discrete adaptive style shifts are allowed.",
                        default_runtime_path="personality.adaptation_min_turns",
                        min_value=1,
                        max_value=200,
                        env_override_keys=("RYO_PERSONALITY_ADAPTATION_MIN_TURNS",),
                    ),
                    RouteSettingSpec(
                        id="personality_adaptation_window_turns",
                        label="Adaptation Window Turns",
                        path="runtime.personality.adaptation_window_turns",
                        value_type="int",
                        description="Minimum turns between discrete adaptive style shifts.",
                        default_runtime_path="personality.adaptation_window_turns",
                        min_value=1,
                        max_value=100,
                        env_override_keys=("RYO_PERSONALITY_ADAPTATION_WINDOW_TURNS",),
                    ),
                    RouteSettingSpec(
                        id="personality_adaptation_max_step_per_window",
                        label="Max Step Per Window",
                        path="runtime.personality.adaptation_max_step_per_window",
                        value_type="int",
                        description="Maximum discrete style-level shift allowed in each adaptation window.",
                        default_runtime_path="personality.adaptation_max_step_per_window",
                        min_value=1,
                        max_value=3,
                        env_override_keys=("RYO_PERSONALITY_ADAPTATION_MAX_STEP_PER_WINDOW",),
                    ),
                    RouteSettingSpec(
                        id="personality_default_tone",
                        label="Default Tone",
                        path="runtime.personality.default_tone",
                        value_type="string",
                    ...
                    RouteSettingSpec(
                        id="personality_default_verbosity",
                        label="Default Verbosity",
                        path="runtime.personality.default_verbosity",
                        value_type="string",
                    ...
                    RouteSettingSpec(
                        id="personality_default_reading_level",
                        label="Default Reading Level",
                        path="runtime.personality.default_reading_level",
                        value_type="string",
                        description="Default reading complexity level for responses.",
                        default_runtime_path="personality.default_reading_level",
                        choices=("simple", "moderate", "advanced"),
                        env_override_keys=("RYO_PERSONALITY_DEFAULT_READING_LEVEL",),
                    ),
                    RouteSettingSpec(
                        id="personality_narrative_source_history_limit",
                        label="Narrative Source History Limit",
                        path="runtime.personality.narrative_source_history_limit",
                        value_type="int",
                        description="Max number of recent turns sampled when generating narrative rollups.",
                        default_runtime_path="personality.narrative_source_history_limit",
                        min_value=2,
                        max_value=50,
                        env_override_keys=("RYO_PERSONALITY_NARRATIVE_SOURCE_HISTORY_LIMIT",),
                    ),
                    RouteSettingSpec(
                        id="personality_max_active_chunks",
                        label="Max Active Narrative Chunks",
                        path="runtime.personality.max_active_chunks",
                        value_type="int",
                        description="Max recent narrative chunks considered for continuity context.",
                        default_runtime_path="personality.max_active_chunks",
                        min_value=1,
                        max_value=50,
                        env_override_keys=("RYO_PERSONALITY_MAX_ACTIVE_CHUNKS",),
                    ),
                    RouteSettingSpec(
                        id="personality_default_format",
                        label="Default Response Format",
                        path="runtime.personality.default_format",
                        value_type="string",
                        description="Default formatting style for generated responses.",
                        default_runtime_path="personality.default_format",
                        choices=("plain", "markdown_light"),
                        env_override_keys=("RYO_PERSONALITY_DEFAULT_FORMAT",),
                    ),
                    RouteSettingSpec(
                        id="personality_default_humor",
                        label="Default Humor Level",
                        path="runtime.personality.default_humor",
                        value_type="string",
                        description="Default humor setting for new user profiles.",
                        default_runtime_path="personality.default_humor",
                        choices=("low", "medium", "high"),
                        env_override_keys=("RYO_PERSONALITY_DEFAULT_HUMOR",),
                    ),
                    RouteSettingSpec(
                        id="personality_default_emoji",
                        label="Default Emoji Level",
                        path="runtime.personality.default_emoji",
                        value_type="string",
                        description="Default emoji usage setting for new user profiles.",
                        default_runtime_path="personality.default_emoji",
                        choices=("off", "minimal", "normal"),
                        env_override_keys=("RYO_PERSONALITY_DEFAULT_EMOJI",),
                    ),
                    RouteSettingSpec(
                        id="personality_default_language",
                        label="Default Language",
                        path="runtime.personality.default_language",
                        value_type="string",
                        description="Default language code used for new personality profiles.",
                        default_runtime_path="personality.default_language",
                        env_override_keys=("RYO_PERSONALITY_DEFAULT_LANGUAGE",),
                    ),
                ),
            ),
        ),
